...
const Layout2: React.FC<{ allquestion: Question[] }> = ({ allquestion: questions=question1 }) => {
    ...
    return (
        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div className="flex justify-between items-center mx-3 my-1">
                ...
                <div>
                    <p>{currentQuestion + 1}/{questions.length} in Layout 2</p>
                </div>
            ...
            <div className="p-5">
                ...
                <a href="#">
               <img className="m-auto rounded-t-lg" src="https://tse3.mm.bing.net/th?id=OIP.iqWVMMbC4GyiuYDuUzOE-QHaEK&pid=Api&P=0&h=180" alt="" />
            </a>
                <button
                    disabled={isChecked}
                    onClick={handleCheck}
                    className={`flex justify-center items-center mt-3 px-3 py-2 text-sm font-medium text-center text-white bg-red-600 rounded-full min-w-full 
