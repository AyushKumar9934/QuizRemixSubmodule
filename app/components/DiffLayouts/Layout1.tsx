...
const Layout1: React.FC<{ allquestion: Question[] }> = ({ allquestion: questions=question1 }) => {
    ...
    return (
        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div className="flex justify-between items-center mx-3 my-1">
                ...
                <div>
                    <p>{currentQuestion + 1}/{questions.length} in Layout1</p>
                </div>
            ...
            <div className="p-5">
                ...
                <div className="pt-4 pb-2">
                    {questions[currentQuestion].answerOptions.map((answerOption, i) => {
                        ...
                        const optionToBeGreen = isChecked && isCorrect;
